...
class Application:
    ...
    def __init__(self):
        ...
        self.panel.place(x=100, y=3, width=600, height=500)

        self.panel2 = tk.Label(self.root)  # initialize image panel
        self.panel2.place(x=800, y=100, width=400, height=400)
